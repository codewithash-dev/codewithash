    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="pt-32 pb-12 px-6">
        <div ref={heroRef} className="max-w-5xl mx-auto">
          <a href="/projects" className="text-purple-400 hover:text-purple-300 mb-6 inline-block">
            ← Back to Projects
          </a>
          ...
          <div className="flex flex-wrap gap-3">
            <span className="px-4 py-2 bg-purple-600/20 text-purple-400 rounded-full">React</span>
            <span className="px-4 py-2 bg-blue-600/20 text-blue-400 rounded-full">Node.js</span>
            <span className="px-4 py-2 bg-green-600/20 text-green-400 rounded-full">Stripe</span>
            <span className="px-4 py-2 bg-orange-600/20 text-orange-400 rounded-full">MongoDB</span>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                A modern e-commerce platform built with React and Node.js. Features include user authentication, product browsing with filters, shopping cart management, secure payment processing with Stripe, and order tracking.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-3">
                  ...
                  <span>User authentication and authorization with JWT</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-400 mt-1">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-purple-400 mt-1">✓</span>
                  <span>Shopping cart with persistent state</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-400 mt-1">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-purple-400 mt-1">✓</span>
                  <span>Admin dashboard for product and order management</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3 text-purple-400">Frontend</h3>
