        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition w-full"
            >
              Add to Cart
            </button>
          </div>
