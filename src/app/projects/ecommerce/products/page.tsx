                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="ecommerce-cta btn-animate w-8 h-8 rounded-lg disabled:opacity-40 disabled:cursor-not-allowed transition"
                    ...
                    <button
                      type="button"
                      onClick={() => updateCart(product.id, 1)}
                      className="ecommerce-cta btn-animate w-8 h-8 rounded-lg transition"
                      style={{ backgroundColor: "#000", color: "#fff", backgroundImage: "none" }}
                    >
                      +
                    </button>
