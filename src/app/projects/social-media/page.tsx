    ...
    <main className="min-h-screen bg-transparent text-white pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <p className="text-xs sm:text-sm text-gray-400 mb-3">
          ...
          <span className="text-gray-300">Social Media App</span>
        </p>
        <h1 className="text-3xl sm:text-4xl font-bold mb-3">Full Stack Social Media App</h1>
        <p className="text-base text-gray-300 max-w-2xl mb-8">
          Instagram-style social app with posts, likes, comments, and profiles.
        </p>
